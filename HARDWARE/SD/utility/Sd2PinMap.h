 ...
 */
#if 1   //defined(__arm__) // Arduino Due Board follows
...
uint8_t const SS_PIN = PB12;
uint8_t const MOSI_PIN = PB14;
uint8_t const MISO_PIN = PB15;
uint8_t const SCK_PIN = PB13;
