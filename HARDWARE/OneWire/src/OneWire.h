...
#define PIN_TO_BITMASK(pin)             (pin)//(uint32_t)digitalPinToBitMask(pin)
#define IO_REG_TYPE uint32_t
#define IO_REG_BASE_ATTR
#define IO_REG_MASK_ATTR
#define DIRECT_READ(base, pin)          (digitalRead(pin))
#define DIRECT_WRITE_LOW(base, pin)     (digitalPinToPort(pin)->BRR = digitalPinToBitMask(pin))
#define DIRECT_WRITE_HIGH(base, pin)    (digitalPinToPort(pin)->BSRR = digitalPinToBitMask(pin))
