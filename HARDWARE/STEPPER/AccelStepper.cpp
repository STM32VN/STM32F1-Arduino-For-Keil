...
void AccelStepper::step1(long step)
{
    ...
    setOutputPins(_direction ? B10 : B00); // Set direction first else get rogue pulses
    setOutputPins(_direction ? B11 : B01); // step HIGH
    // Caution 200ns setup time 
    // Delay the minimum allowed pulse width
    delayMicroseconds(_minPulseWidth);
    setOutputPins(_direction ? B10 : B00); // step LOW
}
