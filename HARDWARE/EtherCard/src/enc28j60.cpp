...
//uint8_t ENC28J60::buffer[500];///////////////tat di bo vao Flie Main.c/////////////
...
#define RANDOM_FILL        B0000
#define ADDRESS_FILL    B0100
#define PATTERN_SHIFT    B1000
#define RANDOM_RACE        B1100
...
// init
    ...
    writeRegByte(EBSTSD, B10101010 | millis());
