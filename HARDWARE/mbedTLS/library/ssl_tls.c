...
void mbedtls_ssl_update_handshake_status( mbedtls_ssl_context *ssl )
{
        ...
        ssl->handshake != NULL )
    {
        ...
        for( offset = 0, hs_buf = (mbedtls_ssl_hs_buffer *)&hs->buffering.hs[0];
...
static int ssl_load_buffered_message( mbedtls_ssl_context *ssl )
{
    ...
    /* Debug only */
    {
        ...
        {
            hs_buf = (mbedtls_ssl_hs_buffer *)&hs->buffering.hs[offset];
    ...
    hs_buf = (mbedtls_ssl_hs_buffer *)&hs->buffering.hs[0];
...
static int ssl_buffer_message( mbedtls_ssl_context *ssl )
{
    ...
    switch( ssl->in_msgtype )
    {
        ...
        case MBEDTLS_SSL_MSG_HANDSHAKE:
        {
            ...
            hs_buf = (mbedtls_ssl_hs_buffer *)&hs->buffering.hs[ recv_msg_seq_offset ];
