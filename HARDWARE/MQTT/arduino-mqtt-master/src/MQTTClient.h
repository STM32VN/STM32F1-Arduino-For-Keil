...
class MQTTClient {
 private:
  ...
  lwmqtt_arduino_network_t network = {NULL};
  lwmqtt_arduino_timer_t timer1 = {0, NULL};
  lwmqtt_arduino_timer_t timer2 = {0, NULL};
 ...
 public:
  ...
  bool connect(const char clientId[], bool skip = false) { return this->connect(clientId, NULL, NULL, skip); }
  bool connect(const char clientId[], const char username[], bool skip = false) {
    return this->connect(clientId, username, NULL, skip);
  }
