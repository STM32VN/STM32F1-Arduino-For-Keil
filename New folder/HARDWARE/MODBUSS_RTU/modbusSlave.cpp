...
*/
void modbusSlave::setBaud(USARTClass* SerialPort, word baud,unsigned char byteFormat,unsigned char _TxEnablePin)
{
	_baud = baud;
	//calculate the time perdiod for 3 characters for the given bps in ms.
	_frameDelay = 72000/_baud;//24000
