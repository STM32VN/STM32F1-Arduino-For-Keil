...
//    }
  ...
  __HAL_RCC_GPIOA_CLK_ENABLE();
	__HAL_RCC_AFIO_CLK_ENABLE();
		/* Configure PA11, PA12  */
  GPIO_InitStructure.Pin = GPIO_PIN_11 | GPIO_PIN_12;//GPIO_PIN_8 |GPIO_PIN_9 ||GPIO_PIN_10
...
//    }
  ...
  __HAL_RCC_GPIOA_CLK_ENABLE();
	...
	__HAL_RCC_AFIO_CLK_ENABLE();
		/* Configure PA11, PA12  */
  GPIO_InitStructure.Pin = g_APinDescription[USB_OTG_FS_DM].ulPin|g_APinDescription[USB_OTG_FS_DP].ulPin;//GPIO_PIN_11 | GPIO_PIN_12;//GPIO_PIN_8 |GPIO_PIN_9 ||GPIO_PIN_10
  GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStructure.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStructure.Pull = GPIO_NOPULL; 
  //GPIO_InitStructure.Alternate = GPIO_AF10_OTG_FS;
  HAL_GPIO_Init(g_APinDescription[USB_OTG_FS_DM].pPort, &GPIO_InitStructure);
...
//    }
  ...
  __HAL_RCC_GPIOA_CLK_ENABLE();
	...
	__HAL_RCC_AFIO_CLK_ENABLE();
		/* Configure PA4  */
  GPIO_InitStructure.Pin = g_APinDescription[USB_OTG_HS_SOF].ulPin;//GPIO_PIN_4;
  GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStructure.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStructure.Pull = GPIO_PULLUP; 
  //GPIO_InitStructure.Alternate = GPIO_AF12_OTG_HS_FS;
  HAL_GPIO_Init(g_APinDescription[USB_OTG_HS_SOF].pPort, &GPIO_InitStructure);
	
	GPIO_InitStructure.Pin = g_APinDescription[USB_OTG_HS_DM].ulPin|g_APinDescription[USB_OTG_HS_DP].ulPin;//GPIO_PIN_14 | GPIO_PIN_15;  
  GPIO_InitStructure.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStructure.Pull = GPIO_PULLUP; 
  //GPIO_InitStructure.Alternate = GPIO_AF12_OTG_HS_FS;
  HAL_GPIO_Init(g_APinDescription[USB_OTG_HS_DM].pPort, &GPIO_InitStructure);
	
	GPIO_InitStructure.Pin = g_APinDescription[USB_OTG_HS_ID].ulPin;//GPIO_PIN_12;  
  GPIO_InitStructure.Mode = GPIO_MODE_AF_OD;
  GPIO_InitStructure.Pull = GPIO_PULLUP; 
  //GPIO_InitStructure.Alternate = GPIO_AF12_OTG_HS_FS;
  HAL_GPIO_Init(g_APinDescription[USB_OTG_HS_ID].pPort, &GPIO_InitStructure);
	
	GPIO_InitStructure.Pin = g_APinDescription[USB_OTG_HS_VBUS].ulPin;//GPIO_PIN_13;  
  GPIO_InitStructure.Mode = GPIO_MODE_INPUT;
  GPIO_InitStructure.Pull = GPIO_NOPULL; 
  //GPIO_InitStructure.Alternate = 0;
  HAL_GPIO_Init(g_APinDescription[USB_OTG_HS_VBUS].pPort, &GPIO_InitStructure);
